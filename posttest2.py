...
def show_menu():
    ...
    if(selected_menu == "2"):
        ...
        clear_screen()
        print("---------------------------------------------------------------------")
        print("Terima kasih telah menggunakan Aplikasi XYZ")
        print("---------------------------------------------------------------------")
        time.sleep(1.5)
        exit()
    else:
...
def biodata_nama():
    ...
    cek = str(input("Apakah Nama Lengkap sudah benar? ('Ya' untuk melanjutkan): "))
    if(cek == "Ya"):
        back_to_biodata()
    else:
        biodata_nama()
...
def biodata_alamat():
    ...
    cek = str(input("Apakah Alamat sudah benar? ('Ya' untuk melanjutkan): "))
    if(cek == "Ya"):
        back_to_biodata()
    else:
        biodata_alamat()
...
def biodata_umur():
    ...
    cek = str(input("Apakah Umur sudah benar? ('Ya' untuk melanjutkan): "))
    if(cek == "Ya"):
        back_to_biodata()
    else:
        biodata_umur()
...
def biodata_tinggi():
    clear_screen()
    inser_tinggi = float(input("Masukkan Tinggi Anda (170.5) Anda: "))
    biodata.pop(3)
    biodata.insert(3,inser_tinggi)
    cek = str(input("Apakah Tinggi sudah benar? ('Ya' untuk melanjutkan): "))
    if(cek == "Ya"):
        back_to_biodata()
    else:
        biodata_tinggi()
...
def biodata_menikah():
    ...
    print("1. Ya")
    print("2. Tidak")
    insert_menikah = str(input("Apakah Anda Menikah? "))
    if(insert_menikah == "1" or insert_menikah == "2"):
        if(insert_menikah == "1"):
            ...
            biodata.pop(4)
            biodata.insert(4,"0")
        cek = str(input("Apakah Status sudah benar? ('Ya' untuk melanjutkan): "))
        if(cek == "Ya"):
            back_to_biodata()
        else:
            biodata_menikah()
...
def smarthome_lampu():
    ...
    if(smarthome[0] == "1"):
        insert_lampu = str(input("Apakah Anda ingin mematikan Lampu? ('Ya' untuk melanjutkan): "))     
        if(insert_lampu == "Ya"):
            smarthome.pop(0)
        ...
        insert_lampu = str(input("Apakah Anda ingin menyalakan Lampu? ('Ya' untuk melanjutkan): "))
        if(insert_lampu == "Ya"):
            smarthome.pop(0)
...
def smarthome_listrik():
    ...
    if(smarthome[1] == "1"):
        insert_listrik = str(input("Apakah Anda ingin mematikan Listrik? "))     
        if(insert_listrik == "Ya"):
            smarthome.pop(1)
        ...
        insert_listrik = str(input("Apakah Anda ingin menyalakan Listrik? "))     
        if(insert_listrik == "Ya"):
            smarthome.pop(1)
...
def smarthome_jendela():
    ...
    if(smarthome[2] == "1"):
        insert_jendela = str(input("Apakah Anda ingin menutup Jendela? "))     
        if(insert_jendela == "Ya"):
            smarthome.pop(2)
        ...
        insert_jendela = str(input("Apakah Anda ingin membuka Jendela? "))     
        if(insert_jendela == "Ya"):
            smarthome.pop(2)
...
def smarthome_pintu():
    ...
    if(smarthome[3] == "1"):
        insert_pintu = str(input("Apakah Anda ingin menutup Pintu? "))     
        if(insert_pintu == "Ya"):
            smarthome.pop(3)
        ...
        insert_pintu = str(input("Apakah Anda ingin membuka Pintu? "))     
        if(insert_pintu == "Ya"):
            smarthome.pop(3)
            smarthome.insert(0,"1")
            back_to_smarthome()
...
def smarthome_stopkontak():
    ...
    if(smarthome[4] == "1"):
        insert_stopkontak = str(input("Apakah Anda ingin mematikan Stop Kontak? "))     
        if(insert_stopkontak == "Ya"):
            smarthome.pop(4)
        ...
        insert_stopkontak = str(input("Apakah Anda ingin menyalakan Stop Kontak? "))     
        if(insert_stopkontak == "Ya"):
            smarthome.pop(4)
